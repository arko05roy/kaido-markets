...
export interface Client {
  /**
   * Construct and simulate a all transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * All registered market addresses, oldest first. (Fine for the launch
   * scale; a paged variant exists for when the list grows.)
   */
  all: (options?: MethodOptions) => Promise<AssembledTransaction<Array<string>>>
   ...
   */
  get: ({market}: {market: string}, options?: MethodOptions) => Promise<AssembledTransaction<MarketInfo>>

  /**
   * Construct and simulate a page transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * A window `[start, start+limit)` of market addresses (registration order).
   */
  page: ({start, limit}: {start: u32, limit: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Array<string>>>
   ...
   */
  register: ({info}: {info: MarketInfo}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  set_factory: ({new_factory}: {new_factory: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAHtBbGwgcmVnaXN0ZXJlZCBtYXJrZXQgYWRkcmVzc2VzLCBvbGRlc3QgZmlyc3QuIChGaW5lIGZvciB0aGUgbGF1bmNoCnNjYWxlOyBhIHBhZ2VkIHZhcmlhbnQgZXhpc3RzIGZvciB3aGVuIHRoZSBsaXN0IGdyb3dzLikAAAAAA2FsbAAAAAAAAAAAAQAAA+oAAAAT",
        "AAAAAAAAAEhUaGUgaW5kZXhlZCBzdW1tYXJ5IGZvciBhIG1hcmtldCAocGFuaWNzIGBQb3NpdGlvbk5vdEZvdW5kYCBpZiB1bmtub3duKS4AAAADZ2V0AAAAAAEAAAAAAAAABm1hcmtldAAAAAAAEwAAAAEAAAfQAAAACk1hcmtldEluZm8AAA==",
        "AAAAAAAAAElBIHdpbmRvdyBgW3N0YXJ0LCBzdGFydCtsaW1pdClgIG9mIG1hcmtldCBhZGRyZXNzZXMgKHJlZ2lzdHJhdGlvbiBvcmRlcikuAAAAAAAABHBhZ2UAAAACAAAAAAAAAAVzdGFydAAAAAAAAAQAAAAAAAAABWxpbWl0AAAAAAAABAAAAAEAAAPqAAAAEw==",
        "AAAAAAAAAApUaGUgYWRtaW4uAAAAAAAFYWRtaW4AAAAAAAAAAAAAAQAAABM=",
        "AAAAAAAAAB1OdW1iZXIgb2YgcmVnaXN0ZXJlZCBtYXJrZXRzLgAAAAAAAAVjb3VudAAAAAAAAAAAAAABAAAABA==",
        "AAAAAAAAACFUaGUgY3VycmVudGx5LWF1dGhvcmlzZWQgZmFjdG9yeS4AAAAAAAAHZmFjdG9yeQAAAAAAAAAAAQAAABM=",
        "AAAAAAAAAEBJbmRleCBhIG1hcmtldC4gQ2FsbGFibGUgb25seSBieSB0aGUgcmVnaXN0ZXJlZCBgTWFya2V0RmFjdG9yeWAuAAAACHJlZ2lzdGVyAAAAAQAAAAAAAAAEaW5mbwAAB9AAAAAKTWFya2V0SW5mbwAAAAAAAA==",
        "AAAAAAAAAEhSb3RhdGUgdGhlIGZhY3RvcnkgYWxsb3dlZCB0byBgcmVnaXN0ZXJgIChlLmcuIGFmdGVyIGEgZmFjdG9yeSB1cGdyYWRlKS4AAAALc2V0X2ZhY3RvcnkAAAAAAQAAAAAAAAALbmV3X2ZhY3RvcnkAAAAAEwAAAAA=",
        "",
  ...
  public readonly fromJSON = {
    all: this.txFromJSON<Array<string>>,
        get: this.txFromJSON<MarketInfo>,
        page: this.txFromJSON<Array<string>>,
