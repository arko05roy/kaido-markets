...
export interface Client {
   ...
   */
  init: ({k, b, fee_bps, resolver, tier, window_open, window_lock, window_resolve, mu0, sigma0, usdc, capped_flag, treasury, creator, fee_lp_bps, fee_treasury_bps, fee_creator_bps, blend_adapter}: {k: i128, b: i128, fee_bps: u32, resolver: string, tier: u32, window_open: u64, window_lock: u64, window_resolve: u64, mu0: i128, sigma0: i128, usdc: string, capped_flag: u32, treasury: string, creator: string, fee_lp_bps: u32, fee_treasury_bps: u32, fee_creator_bps: u32, blend_adapter: Option<string>}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  init_trajectory: ({k, b, fee_bps, resolver, tier, checkpoints, window_open, window_lock, window_resolve, mus0, sigmas0, usdc, treasury, creator, fee_lp_bps, fee_treasury_bps, fee_creator_bps, blend_adapter}: {k: i128, b: i128, fee_bps: u32, resolver: string, tier: u32, checkpoints: Array<u64>, window_open: u64, window_lock: u64, window_resolve: u64, mus0: Array<i128>, sigmas0: Array<i128>, usdc: string, treasury: string, creator: string, fee_lp_bps: u32, fee_treasury_bps: u32, fee_creator_bps: u32, blend_adapter: Option<string>}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a blend_backed_depth transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Blend-backed borrow headroom for this market (7-dp USDC), `0` if disabled.
   */
  blend_backed_depth: (options?: MethodOptions) => Promise<AssembledTransaction<i128>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAADd2FkAAAAAAAAAAABAAAACw==",
        "",
        ...
        "",
        ...
        "AAAAAAAAAEpCbGVuZC1iYWNrZWQgYm9ycm93IGhlYWRyb29tIGZvciB0aGlzIG1hcmtldCAoNy1kcCBVU0RDKSwgYDBgIGlmIGRpc2FibGVkLgAAAAAAEmJsZW5kX2JhY2tlZF9kZXB0aAAAAAAAAAAAAAEAAAAL",
  ...
  public readonly fromJSON = {
    wad: this.txFromJSON<i128>,
        ...
        blend_backed_depth: this.txFromJSON<i128>,
