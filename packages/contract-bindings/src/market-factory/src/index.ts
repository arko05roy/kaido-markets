...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {admin, market_wasm, registry, usdc, treasury}: {admin: string, market_wasm: Buffer, registry: string, usdc: string, treasury: string},
    ...
    return ContractClient.deploy({admin, market_wasm, registry, usdc, treasury}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAEdXNkYwAAAAAAAAABAAAAEw==",
        ...
        "",
