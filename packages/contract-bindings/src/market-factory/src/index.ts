...
export interface Client {
   ...
   */
  create_market: ({creator, k, b, fee_bps, resolver, tier, window_open, window_lock, window_resolve, mu0, sigma0, capped_flag}: {creator: string, k: i128, b: i128, fee_bps: u32, resolver: string, tier: u32, window_open: u64, window_lock: u64, window_resolve: u64, mu0: i128, sigma0: i128, capped_flag: u32}, options?: MethodOptions) => Promise<AssembledTransaction<string>>
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
        ...
        {admin, market_wasm, registry, usdc, treasury, blend_adapter}: {admin: string, market_wasm: Buffer, registry: string, usdc: string, treasury: string, blend_adapter: Option<string>},
    ...
    return ContractClient.deploy({admin, market_wasm, registry, usdc, treasury, blend_adapter}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAEdXNkYwAAAAAAAAABAAAAEw==",
        ...
        "",
        "",
