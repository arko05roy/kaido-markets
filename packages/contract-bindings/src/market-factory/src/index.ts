...
export interface Client {
  ...
  /**
   * Construct and simulate a market_wasm transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  market_wasm: (options?: MethodOptions) => Promise<AssembledTransaction<Buffer>>
   ...
   */
  create_market: ({creator, k, b, fee_bps, resolver, tier, window_open, window_lock, window_resolve, mu0, sigma0}: {creator: string, k: i128, b: i128, fee_bps: u32, resolver: string, tier: u32, window_open: u64, window_lock: u64, window_resolve: u64, mu0: i128, sigma0: i128}, options?: MethodOptions) => Promise<AssembledTransaction<string>>

  /**
   * Construct and simulate a set_market_wasm transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  set_market_wasm: ({new_wasm}: {new_wasm: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a create_trajectory_market transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  create_trajectory_market: ({creator, k, b, fee_bps, resolver, tier, checkpoints, window_open, window_lock, window_resolve, mus0, sigmas0}: {creator: string, k: i128, b: i128, fee_bps: u32, resolver: string, tier: u32, checkpoints: Array<u64>, window_open: u64, window_lock: u64, window_resolve: u64, mus0: Array<i128>, sigmas0: Array<i128>}, options?: MethodOptions) => Promise<AssembledTransaction<string>>

}
export class Client extends ContractClient {
  static async deploy<T = Client>(
        /** Constructor/Initialization Args for the contract's `__constructor` method */
        {admin, market_wasm, registry, usdc}: {admin: string, market_wasm: Buffer, registry: string, usdc: string},
    ...
    return ContractClient.deploy({admin, market_wasm, registry, usdc}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAEdXNkYwAAAAAAAAABAAAAEw==",
        "AAAAAAAAAAAAAAAFYWRtaW4AAAAAAAAAAAAAAQAAABM=",
        "AAAAAAAAADpOdW1iZXIgb2YgbWFya2V0cyBjcmVhdGVkIHNvIGZhciAoPSB0aGUgbmV4dCBkZXBsb3kgc2FsdCkuAAAAAAAFY291bnQAAAAAAAAAAAAAAQAAAAY=",
        "AAAAAAAAAAAAAAAIcmVnaXN0cnkAAAAAAAAAAQAAABM=",
        "AAAAAAAAAAAAAAALbWFya2V0X3dhc20AAAAAAAAAAAEAAAPuAAAAIA==",
        "",
        "",
        "",
        "",
        ...
        "",
  ...
  public readonly fromJSON = {
    usdc: this.txFromJSON<string>,
        ...
        market_wasm: this.txFromJSON<Buffer>,
        create_market: this.txFromJSON<string>,
        set_market_wasm: this.txFromJSON<null>,
        create_trajectory_market: this.txFromJSON<string>
  }
}