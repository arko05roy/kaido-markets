...
export const ResolverError = {
  ...
  4: {message:"BadSignature"},
  5: {message:"ReportExpired"},
  6: {message:"AlreadyFinalized"},
  7: {message:"NoPendingReport"},
  8: {message:"ChallengeWindowClosed"},
  9: {message:"AlreadyDisputed"},
  10: {message:"NotInChallengeWindow"},
  11: {message:"NotFinalized"}
}
...
export interface Client {
   ...
   */
  phase: (options?: MethodOptions) => Promise<AssembledTransaction<AttestedPhase>>
   ...
   */
  dispute: ({disputer}: {disputer: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a poster_pubkey transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  poster_pubkey: (options?: MethodOptions) => Promise<AssembledTransaction<Buffer>>
   ...
   */
  submit_report: ({value, reported_at, signature}: {value: i128, reported_at: u64, signature: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a pending_report transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  pending_report: (options?: MethodOptions) => Promise<AssembledTransaction<Option<PendingReport>>>

  /**
   * Construct and simulate a report_message_hash transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * SHA-256 of the canonical signed payload (for off-chain poster tooling).
   */
  report_message_hash: ({value, reported_at}: {value: i128, reported_at: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Buffer>>

  /**
   * Construct and simulate a challenge_window_secs transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  challenge_window_secs: (options?: MethodOptions) => Promise<AssembledTransaction<u64>>

}
export class Client extends ContractClient {
  static async deploy<T = Client>(
        /** Constructor/Initialization Args for the contract's `__constructor` method */
        {poster_pubkey, resolve_time, challenge_window_secs}: {poster_pubkey: Buffer, resolve_time: u64, challenge_window_secs: u64},
    ...
    return ContractClient.deploy({poster_pubkey, resolve_time, challenge_window_secs}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAwAAAAAAAAAAAAAADUF0dGVzdGVkUGhhc2UAAAAAAAAEAAAAAAAAAA5Bd2FpdGluZ1JlcG9ydAAAAAAAAAAAAAAAAAAPQ2hhbGxlbmdlV2luZG93AAAAAAEAAAAAAAAACERpc3B1dGVkAAAAAgAAAAAAAAAJRmluYWxpemVkAAAAAAAAAw==",
        "AAAAAQAAAAAAAAAAAAAADVBlbmRpbmdSZXBvcnQAAAAAAAADAAAAAAAAABJjaGFsbGVuZ2VfZGVhZGxpbmUAAAAAAAYAAAAAAAAAC3JlcG9ydGVkX2F0AAAAAAYAAAAAAAAABXZhbHVlAAAAAAAACw==",
        "",
        "AAAAAAAAAAAAAAAFcGhhc2UAAAAAAAAAAAAAAQAAB9AAAAANQXR0ZXN0ZWRQaGFzZQAAAA==",
        "AAAAAAAAAAAAAAAGc3RhdHVzAAAAAAAAAAAAAQAAB9AAAAAOUmVzb2x2ZXJTdGF0dXMAAA==",
        "AAAAAAAAAAAAAAAHZGlzcHV0ZQAAAAABAAAAAAAAAAhkaXNwdXRlcgAAABMAAAAA",
        ...
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAMAAAAAAAAADXBvc3Rlcl9wdWJrZXkAAAAAAAPuAAAAIAAAAAAAAAAMcmVzb2x2ZV90aW1lAAAABgAAAAAAAAAVY2hhbGxlbmdlX3dpbmRvd19zZWNzAAAAAAAABgAAAAA=",
        "AAAAAAAAAAAAAAANcG9zdGVyX3B1YmtleQAAAAAAAAAAAAABAAAD7gAAACA=",
        "AAAAAAAAAAAAAAANc3VibWl0X3JlcG9ydAAAAAAAAAMAAAAAAAAABXZhbHVlAAAAAAAACwAAAAAAAAALcmVwb3J0ZWRfYXQAAAAABgAAAAAAAAAJc2lnbmF0dXJlAAAAAAAD7gAAAEAAAAAA",
        "AAAAAAAAAAAAAAAOcGVuZGluZ19yZXBvcnQAAAAAAAAAAAABAAAD6AAAB9AAAAANUGVuZGluZ1JlcG9ydAAAAA==",
        "AAAAAAAAAEdTSEEtMjU2IG9mIHRoZSBjYW5vbmljYWwgc2lnbmVkIHBheWxvYWQgKGZvciBvZmYtY2hhaW4gcG9zdGVyIHRvb2xpbmcpLgAAAAATcmVwb3J0X21lc3NhZ2VfaGFzaAAAAAACAAAAAAAAAAV2YWx1ZQAAAAAAAAsAAAAAAAAAC3JlcG9ydGVkX2F0AAAAAAYAAAABAAAD7gAAACA=",
        "AAAAAAAAAAAAAAAVY2hhbGxlbmdlX3dpbmRvd19zZWNzAAAAAAAAAAAAAAEAAAAG",
  ...
  public readonly fromJSON = {
    phase: this.txFromJSON<AttestedPhase>,
        ...
        poster_pubkey: this.txFromJSON<Buffer>,
        submit_report: this.txFromJSON<null>,
        pending_report: this.txFromJSON<Option<PendingReport>>,
        report_message_hash: this.txFromJSON<Buffer>,
        challenge_window_secs: this.txFromJSON<u64>
  }
}