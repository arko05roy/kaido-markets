...
export interface Client {
  /**
   * Construct and simulate a cap transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * The configured per-market cap on cumulative exposure (7-dp USDC),
   * `0` if unset.
   */
  cap: ({market}: {market: string}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>
  ...
  /**
   * Construct and simulate a set_cap transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  set_cap: ({market, cap_7dp}: {market: string, cap_7dp: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  seed_market: ({market, amount_7dp}: {market: string, amount_7dp: i128}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAE9UaGUgY29uZmlndXJlZCBwZXItbWFya2V0IGNhcCBvbiBjdW11bGF0aXZlIGV4cG9zdXJlICg3LWRwIFVTREMpLApgMGAgaWYgdW5zZXQuAAAAAANjYXAAAAAAAQAAAAAAAAAGbWFya2V0AAAAAAATAAAAAQAAAAs=",
        "AAAABQAAAAAAAAAAAAAABkNhcFNldAAAAAAAAQAAAAdjYXBfc2V0AAAAAAIAAAAAAAAABm1hcmtldAAAAAAAEwAAAAAAAAAAAAAAA2NhcAAAAAALAAAAAAAAAAI=",
        "AAAABQAAAAAAAAAAAAAABlNlZWRlZAAAAAAAAQAAAAZzZWVkZWQAAAAAAAMAAAAAAAAABm1hcmtldAAAAAAAEwAAAAAAAAAAAAAABmFtb3VudAAAAAAACwAAAAAAAAAAAAAABnNoYXJlcwAAAAAACwAAAAAAAAAC",
        ...
        "",
        ...
        "",
  ...
  public readonly fromJSON = {
    cap: this.txFromJSON<i128>,
        deposit: this.txFromJSON<null>,
        set_cap: this.txFromJSON<null>,
