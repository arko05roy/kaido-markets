...
export interface Client {
   ...
   */
  deposit: ({from, amount_7dp}: {from: string, amount_7dp: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a exposure transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * The vault's recorded cumulative exposure to `market` (7-dp USDC).
   */
  exposure: ({market}: {market: string}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>

  /**
   * Construct and simulate a seed_market transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  seed_market: ({market, amount_7dp, cap_7dp}: {market: string, amount_7dp: i128, cap_7dp: i128}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>

  /**
   * Construct and simulate a withdraw_proportional transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  withdraw_proportional: ({market, shares}: {market: string, shares: i128}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABQAAAAAAAAAAAAAABlNlZWRlZAAAAAAAAQAAAAZzZWVkZWQAAAAAAAMAAAAAAAAABm1hcmtldAAAAAAAEwAAAAAAAAAAAAAABmFtb3VudAAAAAAACwAAAAAAAAAAAAAABnNoYXJlcwAAAAAACwAAAAAAAAAC",
        "AAAABQAAAAAAAAAAAAAACURlcG9zaXRlZAAAAAAAAAEAAAAJZGVwb3NpdGVkAAAAAAAAAgAAAAAAAAAEZnJvbQAAABMAAAAAAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAAAAAAAg==",
        "AAAABQAAAAAAAAAAAAAACVdpdGhkcmF3bgAAAAAAAAEAAAAJd2l0aGRyYXduAAAAAAAAAwAAAAAAAAAGbWFya2V0AAAAAAATAAAAAAAAAAAAAAAGc2hhcmVzAAAAAAALAAAAAAAAAAAAAAAGYW1vdW50AAAAAAALAAAAAAAAAAI=",
        "AAAAAAAAABpBbnlvbmUgbWF5IGZ1bmQgdGhlIHZhdWx0LgAAAAAAB2RlcG9zaXQAAAAAAgAAAAAAAAAEZnJvbQAAABMAAAAAAAAACmFtb3VudF83ZHAAAAAAAAsAAAAA",
        "AAAAAAAAAEFUaGUgdmF1bHQncyByZWNvcmRlZCBjdW11bGF0aXZlIGV4cG9zdXJlIHRvIGBtYXJrZXRgICg3LWRwIFVTREMpLgAAAAAAAAhleHBvc3VyZQAAAAEAAAAAAAAABm1hcmtldAAAAAAAEwAAAAEAAAAL",
        "",
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAIAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAEdXNkYwAAABMAAAAA",
        "",
        "AAAAAAAAAAAAAAADd2FkAAAAAAAAAAABAAAACw==",
  ...
  public readonly fromJSON = {
    deposit: this.txFromJSON<null>,
        exposure: this.txFromJSON<i128>,
        seed_market: this.txFromJSON<i128>,
        withdraw_proportional: this.txFromJSON<i128>,
