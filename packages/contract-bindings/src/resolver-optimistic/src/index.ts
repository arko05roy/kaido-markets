...
export const ResolverError = {
  ...
  3: {message:"NotYetResolveTime"},
  4: {message:"BondTooSmall"},
  5: {message:"AlreadyFinalized"},
  6: {message:"ActiveProposalExists"},
  7: {message:"NoActiveProposal"},
  8: {message:"DisputeWindowClosed"},
  9: {message:"BondTooLowForDispute"},
  10: {message:"AlreadyDisputed"},
  11: {message:"NotInDisputeWindow"},
  12: {message:"NotDisputed"},
  13: {message:"NotFinalized"},
  14: {message:"UnauthorizedCommittee"}
}

export enum OptimisticPhase {
  AwaitingProposal = 0,
  DisputeWindow = 1,
  Disputed = 2,
  Finalized = 3,
...
export interface Client {
   ...
   */
  phase: (options?: MethodOptions) => Promise<AssembledTransaction<OptimisticPhase>>
   ...
   */
  dispute: ({disputer, value, bond}: {disputer: string, value: i128, bond: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  propose: ({proposer, value, bond}: {proposer: string, value: i128, bond: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a min_bond transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  min_bond: (options?: MethodOptions) => Promise<AssembledTransaction<i128>>

  /**
   * Construct and simulate a arbitrate transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Committee picks the winning value; loser's bond goes to the winner.
   */
  arbitrate: ({arbiter, value}: {arbiter: string, value: i128}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
  ...
  /**
   * Construct and simulate a active_dispute transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  active_dispute: (options?: MethodOptions) => Promise<AssembledTransaction<Option<DisputeRecord>>>

  /**
   * Construct and simulate a active_proposal transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  active_proposal: (options?: MethodOptions) => Promise<AssembledTransaction<Option<Proposal>>>

}
export class Client extends ContractClient {
  static async deploy<T = Client>(
        /** Constructor/Initialization Args for the contract's `__constructor` method */
        {usdc, committee, resolve_time, dispute_window_secs, min_bond}: {usdc: string, committee: string, resolve_time: u64, dispute_window_secs: u64, min_bond: i128},
    ...
    return ContractClient.deploy({usdc, committee, resolve_time, dispute_window_secs, min_bond}, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAACFByb3Bvc2FsAAAABQAAAAAAAAAEYm9uZAAAAAsAAAAAAAAAEGRpc3B1dGVfZGVhZGxpbmUAAAAGAAAAAAAAAAtwcm9wb3NlZF9hdAAAAAAGAAAAAAAAAAhwcm9wb3NlcgAAABMAAAAAAAAABXZhbHVlAAAAAAAACw==",
        "AAAAAQAAAAAAAAAAAAAADURpc3B1dGVSZWNvcmQAAAAAAAADAAAAAAAAAARib25kAAAACwAAAAAAAAAIZGlzcHV0ZXIAAAATAAAAAAAAAAV2YWx1ZQAAAAAAAAs=",
        "",
        "AAAAAwAAAAAAAAAAAAAAD09wdGltaXN0aWNQaGFzZQAAAAAEAAAAAAAAABBBd2FpdGluZ1Byb3Bvc2FsAAAAAAAAAAAAAAANRGlzcHV0ZVdpbmRvdwAAAAAAAAEAAAAAAAAACERpc3B1dGVkAAAAAgAAAAAAAAAJRmluYWxpemVkAAAAAAAAAw==",
        "AAAAAAAAAAAAAAAFcGhhc2UAAAAAAAAAAAAAAQAAB9AAAAAPT3B0aW1pc3RpY1BoYXNlAA==",
        "AAAAAAAAAAAAAAAGc3RhdHVzAAAAAAAAAAAAAQAAB9AAAAAOUmVzb2x2ZXJTdGF0dXMAAA==",
        "AAAAAAAAAAAAAAAHZGlzcHV0ZQAAAAADAAAAAAAAAAhkaXNwdXRlcgAAABMAAAAAAAAABXZhbHVlAAAAAAAACwAAAAAAAAAEYm9uZAAAAAsAAAAA",
        "AAAAAAAAAAAAAAAHcHJvcG9zZQAAAAADAAAAAAAAAAhwcm9wb3NlcgAAABMAAAAAAAAABXZhbHVlAAAAAAAACwAAAAAAAAAEYm9uZAAAAAsAAAAA",
        "AAAAAAAAAAAAAAAHcmVzb2x2ZQAAAAAAAAAAAQAAAAs=",
        "AAAAAAAAAAAAAAAIZmluYWxpemUAAAAAAAAAAA==",
        "AAAAAAAAAAAAAAAIbWluX2JvbmQAAAAAAAAAAQAAAAs=",
        "AAAAAAAAAENDb21taXR0ZWUgcGlja3MgdGhlIHdpbm5pbmcgdmFsdWU7IGxvc2VyJ3MgYm9uZCBnb2VzIHRvIHRoZSB3aW5uZXIuAAAAAAlhcmJpdHJhdGUAAAAAAAACAAAAAAAAAAdhcmJpdGVyAAAAABMAAAAAAAAABXZhbHVlAAAAAAAACwAAAAA=",
        "AAAAAAAAAAAAAAAMcmVzb2x2ZV90aW1lAAAAAAAAAAEAAAAG",
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAUAAAAAAAAABHVzZGMAAAATAAAAAAAAAAljb21taXR0ZWUAAAAAAAATAAAAAAAAAAxyZXNvbHZlX3RpbWUAAAAGAAAAAAAAABNkaXNwdXRlX3dpbmRvd19zZWNzAAAAAAYAAAAAAAAACG1pbl9ib25kAAAACwAAAAA=",
        "AAAAAAAAAAAAAAAOYWN0aXZlX2Rpc3B1dGUAAAAAAAAAAAABAAAD6AAAB9AAAAANRGlzcHV0ZVJlY29yZAAAAA==",
        "AAAAAAAAAAAAAAAPYWN0aXZlX3Byb3Bvc2FsAAAAAAAAAAABAAAD6AAAB9AAAAAIUHJvcG9zYWw=",
  ...
  public readonly fromJSON = {
    phase: this.txFromJSON<OptimisticPhase>,
        ...
        min_bond: this.txFromJSON<i128>,
        arbitrate: this.txFromJSON<null>,
        resolve_time: this.txFromJSON<u64>,
        active_dispute: this.txFromJSON<Option<DisputeRecord>>,
        active_proposal: this.txFromJSON<Option<Proposal>>
  }
}