      ...
      <div className="relative h-9 w-full" aria-hidden>
        ...
        <div
          className={cn(
            ...
            live ? "bg-[#d8c69a]/30" : settled ? "bg-white/[0.08]" : "bg-[#d8c69a]/18",
          )}
          style={{
            left: `${rail.zoneLeft}%`,
        ...
        {rail.outcomePct != null && (
          <div
            className="absolute top-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#f3efe6]/80 bg-[#f3efe6] shadow-[0_0_10px_rgba(243,239,230,0.35)]"
...
export function MarketCardItem({
  ...
  return (
    <Link href={`/markets/${address}`} className="group block h-full">
      <article
        className={cn(
          "flex h-full flex-col overflow-hidden rounded-2xl border border-white/[0.06] bg-[#1c1c21]",
      ...
      >
        <div className="flex flex-1 flex-col gap-4 p-5 sm:p-6">
          ...
          {/* thesis: the question */}
          <h2 className="font-serif text-[1.2rem] leading-[1.2] tracking-[-0.02em] text-[#f3efe6] sm:text-[1.35rem]">
            {title}
          </h2>

          {/* signature: range rail */}
          {rail && crowd ? (
